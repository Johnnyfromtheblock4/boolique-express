...
// POST /products - Crea un nuovo prodotto (con upload immagini)
router.post("/", upload.array("files", 10), productsController.store);

// PUT /products/:id - Aggiorna un prodotto completamente (con upload immagini)
